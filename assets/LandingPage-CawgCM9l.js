import{j as e}from"./index-oJkx2L23.js";import{b as r,L as l}from"./vendor-BO-UU5I_.js";const p=()=>{const[o,s]=r.useState([]),t=r.useMemo(()=>["💒","💍","💐","❤️","💑","🎉","🥂","💕"],[]);r.useEffect(()=>{const a=[];for(let n=0;n<15;n++)a.push({id:Date.now()+n,emoji:t[Math.floor(Math.random()*t.length)],left:Math.random()*100,delay:Math.random()*5,duration:3+Math.random()*4});s(a);const i=setInterval(()=>{s(n=>[...n.slice(-19),{id:Date.now(),emoji:t[Math.floor(Math.random()*t.length)],left:Math.random()*100,delay:0,duration:3+Math.random()*4}])},800);return()=>clearInterval(i)},[t]);const d=r.useMemo(()=>[{name:"Connections",path:"/connections",description:"Find groups of four!"},{name:"The Mini",path:"/wedding-crossword",description:"Wedding crossword puzzle"},{name:"Wedding Strands",path:"/wedding-strands",description:"Find the hidden words"},{name:"Our Timeline",path:"/our-timeline",description:"Arrange events in order"},{name:"True or False",path:"/true-false",description:"Test your knowledge!"}],[]);return e.jsxs("div",{className:"min-h-screen bg-gradient-to-br from-pink-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-8 px-4 relative overflow-hidden",children:[e.jsx("div",{className:"fixed inset-0 pointer-events-none overflow-hidden",style:{zIndex:1},children:o.map(a=>e.jsx("div",{className:"absolute text-4xl animate-fall",style:{left:`${a.left}%`,animationDelay:`${a.delay}s`,animationDuration:`${a.duration}s`,top:"-60px"},children:a.emoji},a.id))}),e.jsxs("div",{className:"relative z-10 max-w-4xl mx-auto",children:[e.jsxs("div",{className:"text-center mb-12",children:[e.jsx("h1",{style:{fontSize:"clamp(2rem, 5vw, 3rem)",paddingTop:"60px"},className:"font-bold mb-2 animate-fadeIn text-gray-900 dark:text-gray-100",children:"Welcome to our wedding! 💕"}),e.jsx("p",{className:"text-2xl md:text-3xl text-gray-600 dark:text-gray-300 animate-fadeIn",style:{animationDelay:"0.3s"},children:"Sofia and Joel invite you to try some of our favourite puzzles with a wedding day twist!"})]}),e.jsx("div",{className:"grid md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-3 sm:scale-90 mt-16 sm:mt-8",children:d.map((a,i)=>e.jsxs(l,{to:a.path,className:`group bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 
